...
It uses two (later 3) technical parts to get it to work. First, we have the ESP32 platform that aloows for interfacing and connection to (a) home assistant implementation, if preferred. I may consider som autonomous functions, but first lets see if we can get som basics going.
